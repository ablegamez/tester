...
function molinaStart() {
  //DISPLAY SET UP
  cleardiv("bodyDiv");
  //alert("Molina");
  createtxt("bodyDiv", "Name: ");
  createelem("bodyDiv", "input", "nameBox");
  createtxt("bodyDiv", "Gender: ");
  createelem("bodyDiv", "input", "genderBox");
  createbr("bodyDiv");
  createtxt("bodyDiv", "PCP: ");
  createelem("bodyDiv", "input", "pcpBox");
  createtxt("bodyDiv", "phone: ");
  createelem("bodyDiv", "input", "pcpPhoneBox");
  createbr("bodyDiv");
  createtable("bodyDiv", "demoTable");
}
...
function addText() {
  ...
  if (document.getElementById("textbox1").value != "") {
    document.getElementById("textbox1").value = validateTxt(
      document.getElementById("textbox1").value
    );
    txt1 = txt1 + "Goal: " + document.getElementById("textbox1").value + "\n";
  }
  if (document.getElementById("textbox2").value != "") {
    document.getElementById("textbox2").value = validateTxt(
      document.getElementById("textbox2").value
    );
    txt1 =
      txt1 + "Conflict: " + document.getElementById("textbox2").value + "\n";
  }
  if (document.getElementById("textbox3").value != "") {
    document.getElementById("textbox3").value = validateTxt(
      document.getElementById("textbox3").value
    );
    txt1 =
      txt1 + "Disaster: " + document.getElementById("textbox3").value + "\n";
  }
  if (document.getElementById("textbox4").value != "") {
    document.getElementById("textbox4").value = validateTxt(
  ...
  if (document.getElementById("textbox5").value != "") {
    document.getElementById("textbox5").value = validateTxt(
      document.getElementById("textbox5").value
    );
    txt1 =
      txt1 + "Dilemma: " + document.getElementById("textbox5").value + "\n";
  }
  if (document.getElementById("textbox6").value != "") {
    document.getElementById("textbox6").value = validateTxt(
      document.getElementById("textbox6").value
    );
    txt1 =
      txt1 + "Decision: " + document.getElementById("textbox6").value + "\n";
  }
...
function addMruText() {
  ...
  if (document.getElementById("titleTextBox").value != "") {
    txt1 = "MRU: \n\n";
    txt1 =
      txt1 + "Title: " + document.getElementById("titleTextBox").value + "\n";
  }
  if (document.getElementById("textbox1").value != "") {
    document.getElementById("textbox1").value = validateTxt(
      document.getElementById("textbox1").value
...
function copyClipboard() {
  ...
  textToCopy = document.getElementById("finalTextBox").select();
  navigator.clipboard
